...
<script>
import Example1 from "../../../static/example/calendarHeatMap/1.vue";
...
export default {
  ...
  data() {
    return {
      basicData: {},
      componentPath: "/static/example/calendarHeatMap/1.vue",
      exampleSelect: "",
      activeNames: "1",
      exampleCodeDialog: {
        visible: false,
        ...
        data: [
          {
            name:"plot:click",
            param:"-",
            description:"当点击整个图表区域时触发该事件"
          },
          {
            name:"tooltip:change",
            param:"-",
            description:"当鼠标从某方格区域移入/移出到另一方格区域时触发该事件"
          }
        ],
      },
      paramDescription: {
        ...
        data: [
          ...
          {
            name: "renderer",
            description: "设置图表渲染方式为 canvas 或 svg。",
            type: "string",
            option: "-",
            default: "canvas",
            protocol:'optional',
          ...
          option: "-",
            default: "'auto'",  protocol:'optional',
          },
          {
            name: "colorField",
            description: "颜色映射字段名。",
         ...
         option: "-",
            default: "采用 theme 中的色板。",   protocol:'optional',
          },
          {
            name: "reflect",
            description: "坐标轴映射。",
            type: "string",
          option: "-",
            default: "x | y",  protocol:'optional',
          },
          {
            name: "shape",
            description: "热力格子中的形状，密度热力图不用指定。",
            type: "string",
          option: "-",
            default: "rect | square | circle",  protocol:'optional',
          },
          {
            name: "colorField",
            description: "颜色映射字段名。",
  ...
  methods: {
    ...
    exampleCallback2() {
      var tData = { ...this.basicData };
      tData.color='#6E32C2-#1890FF-#12CCCC-#80FF73-#FAFFA8-#80FF73-#12CCCC-#1890FF-#6E32C2-'
      this.updateExampleData(tData);
    },
    exampleCallback3() {
      var tData = { ...this.basicData };
