...
<script>
import Example1 from "../../../static/example/arcChart/1";
...
export default {
  ...
  data() {
    return {
      basicData: {},
      componentPath: "/static/example/arcChart/1.vue",
      exampleSelect: "",
      activeNames: "1",
      exampleCodeDialog: {
        visible: false,
      ...
      paramDescription: {
        ...
        data: [
          {
            name: "id",
            description: "节点或边的唯一id，必修是唯一的String",
            type: "String",
            option: "-",
            default: "-",
          },
          {
            name: "type",
            description: "指定节点类型，内置节点类型名词或自定义节点名称",
            type: "String",
            option: "-",
            default: "circle",
          },
          ...
          {
            name: "cursor",
            description: "鼠标在该边上的鼠标样式，css的cursor属性都支持",
            type: "String",
            option: "-",
            default: "-",
          },
