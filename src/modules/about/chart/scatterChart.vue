<template>
  <div style="padding: 20px 40px">
    <div style="margin-bottom: 10px; width: 1000px;">
      <el-alert
        type="warning"
        title="该组件依赖world_new.js脚本，用于组件代码中echarts注册世界地图, 该脚本当前在static/map/目录下(world_new.js)。在使用该组件时需要保证static/map/目录下有world_new.js地图注册脚本。"
        :closable="false"
      >
      </el-alert>
    </div>
...
<script>
import Example1 from "../../../../static/example/scatterChart/1.vue";
...
export default {
  ...
  data() {
    return {
      basicData: {},
      componentPath: "/static/example/scatterChart/1.vue",
      exampleSelect: "",
      activeNames: "1",
      exampleCodeDialog: {
        visible: false,
        ...
        data: [
          {
            name: "node-click",
            param: "data",
            description: "当点击散点时触发该事件",
          },
          {
            name: "geo-click",
            param: "name",
            description: "点击地图区域时触发该事件",
          },
          {
            name: "node-mouseover",
            param: "data",
            description: "当鼠标移到某个散点时触发该事件",
          },
          {
            name: "geo-mouseover",
            param: "name",
            description: "当鼠标移到某个地图区域时触发该事件",
          },
          {
            name: "node-mouseout",
            param: "data",
            description: "当鼠标移出某个散点时触发该事件",
          },
          {
            name: "geo-mouseout",
            param: "name",
            description: "当鼠标移出某个地图区域时触发该事件",
          },
        ],
      },
      paramDescription: {
        ...
        data: [
          {
            name: "itemStyle",
            description:
              "散点的样式和属性。itemStyle.type=effectScatter时,请参考https://echarts.apache.org/zh/option.html#series-effectScatter；itemStyle.type=scatter时, 请参考https://echarts.apache.org/zh/option.html#series-scatter",
            type: "Object",
            option: "-",
            default: "-",
          },
          ...
          },
          {
            name: "geoStyle",
            description:
              "地图区域的样式和属性。请参考https://echarts.apache.org/zh/option.html#geo",
            type: "Object",
            option: "-",
            default: "-",
          },
  ...
  methods: {
    updateExampleData(data) {
      if (this.$refs.exampleItem.updateData) {
